...
class PetProfile2 extends StatefulWidget {
  @override
  _PetProfile2State createState() => _PetProfile2State();
}
...
class _PetProfile2State extends State<PetProfile2> {
  ...
  void initState() {
    super.initState();
    // Get volEmail from BookingDetailsGetterProvider
    ownerEmail =
        Provider.of<BookingDetailsGetterProvider>(context, listen: false)
            .ownerEmail;
    print("Ownerwa eMAIL WA ISWA : ${ownerEmail}");
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer<BookingDetailsGetterProvider>(
