...
class PetLostAddress extends StatefulWidget {
  const PetLostAddress({Key? key}) : super(key: key);

  @override
  State<PetLostAddress> createState() => _PetLostAddressState();
}

class _PetLostAddressState extends State<PetLostAddress> {
                  ...
                  children: [
                    Card(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          'A detailed address will increase the chance to find your pet!',
                          style: TextStyle(
                            fontSize: 16,
  ...
  Future<void> saveLostAddress() async {
    try {
      String userId = FirebaseAuth.instance.currentUser!.uid;
      await _ownerFireStore.saveLostAddress(
          userId: userId,
