                ...
                return _buildPetItem(
                  ...
                  onTap: () {
                    setState(() {
                      ...
                      bookingDetailsProvider.setPet(selectedPets); // Update here
                    });
                  },
                );
              },
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 12),
              _buildSummaryItem('Selected Pet(s)', selectedPets.join(', ')),
                          SizedBox(height: 12),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        bookingDetailsProvider.setStartDate(startDate?.toIso8601String() );
                        bookingDetailsProvider.setEndDate(endDate?.toIso8601String() );
