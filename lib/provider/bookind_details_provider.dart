...
class BookingDetailsProvider extends ChangeNotifier {
  ...
  Future<void> loadDetails(BuildContext context) async {
    uid = Provider.of<VolunteerDetailsGetterProvider>(context, listen: false).currentuid;
  ...
  Future<void> loadPetData(BuildContext context) async {
    String ownerEmail = Provider.of<OwnerDetailsGetterProvider>(context, listen: false).email;
  ...
  Future<void> saveBooking(BuildContext context) async {
    ...
    if (_service == null || _pet == null || _totalHours == null || _totalPrice == null) {
      showSnackBar(context, "Either service or pet or totalHours or totalPrice is null");
      return;
    }
